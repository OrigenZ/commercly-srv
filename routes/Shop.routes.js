...
router.get('/cart/add-item/:productId', async (req, res, next) => {
...
router.get('/cart/remove-item/:productId', async (req, res, next) => {
  const { productId } = req.params
  const cartId = req.session.currentCartId
...
//GET remove product from cart
router.get('/cart/remove-line/:productId', async (req, res, next) => {
  const { productId } = req.params
  const cartId = req.session.currentCartId
